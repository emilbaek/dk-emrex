 ...
 */
package dk.kmd.emrex.smp;

import fi.csc.emrex.common.model.Person;
import dk.kmd.emrex.smp.model.Link;
import dk.kmd.emrex.smp.model.VerifiedReport;
...
public class JsonController {
    ...
    public SessionData sessionData(@RequestBody NCPChoice choice, HttpServletRequest request) throws Exception {
        ...
        result.setNcpPublicKey(DkSmpApplication.getPubKeyByReturnUrl(choice.getUrl(), emregUrl));
        result.setUrl(DkSmpApplication.getUrl(choice, request));
    ...
    public List<NCPResult> ncps() throws Exception {
        ...
        if (results == null) {
            results = DkSmpApplication.getNCPs(emregUrl);
